...
message.channel.send(`${client.emojis.cache.find(x => x.name === "ramal_yildiz")} Hepinize merhabalar **${message.guild.name}** Sunucuya girdiğinizden itibaren <@&965179493377540166> & <@&965179494237364274> & <@&965656562259603567> rolleri üzerinize verildi! Bu rolleri kaldırmak için uygun butonlara tıklamanız yeterli olacaktır!\n
