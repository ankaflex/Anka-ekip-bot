...
Sunucu Etiket \`(${conf.prefix[0]}setup Etiket <serverETİKET>)\`
...
Tag5 ( **${y.TAG5 ? y.TAG5 : "\`Kapalı\`"}** )
Tag6 ( **${y.TAG6 ? y.TAG6 : "\`Kapalı\`"}** )
Tag7 ( **${y.TAG7 ? y.TAG7 : "\`Kapalı\`"}** )
Etiket ( **${y.ETİKET ? y.ETİKET : "\`Kapalı\`"}** )
