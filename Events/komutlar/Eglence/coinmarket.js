...
════════════════════════════════
\`\`\`ID  ÜRÜN                         FİYAT\`\`\`
\`1\` ${client.emojis.cache.find(x => x.name === "ramal_stat")} **\`Spotify Hesap\`**\`------------------ 3.000\` ${client.emojis.cache.find(x => x.name === "ramal_coin")}
\`2\` ${client.emojis.cache.find(x => x.name === "ramal_stat")} **\`Exxen Hesap\`**\`-------------------- 3.200\` ${client.emojis.cache.find(x => x.name === "ramal_coin")}
\`3\` ${client.emojis.cache.find(x => x.name === "ramal_stat")} **\`Netflix Hesap\`**\`------------------ 4.500\` ${client.emojis.cache.find(x => x.name === "ramal_coin")}
\`4\` ${client.emojis.cache.find(x => x.name === "ramal_stat")} **\`BluTV Hesap\`**\`-------------------- 6.500\` ${client.emojis.cache.find(x => x.name === "ramal_coin")}
\`5\` ${client.emojis.cache.find(x => x.name === "ramal_stat")} **\`1.000 Mesaj\`**\`-------------------- 7.000\` ${client.emojis.cache.find(x => x.name === "ramal_coin")}
\`6\` ${client.emojis.cache.find(x => x.name === "ramal_stat")} **\`10 saat Public Ses\`**\`------------ 20.000\` ${client.emojis.cache.find(x => x.name === "ramal_coin")}
\`7\` ${client.emojis.cache.find(x => x.name === "ramal_stat")} **\`Classic Nitro\`**\`----------------- 38.000\` ${client.emojis.cache.find(x => x.name === "ramal_coin")}
\`8\` ${client.emojis.cache.find(x => x.name === "ramal_stat")} **\`Boost Nitro\`**\`------------------- 66.000\` ${client.emojis.cache.find(x => x.name === "ramal_coin")}
