...
module.exports.run = async (client, message, args, durum, kanal) => {
    ...
    return message.channel.send(`${message.author}, ${client.emojis.cache.find(x => x.name === "ramal_coin")} **${data.coin.toFixed(0)}**  coinin var harcamak için \`.coinmarket\` yazabilirsin`);
}
